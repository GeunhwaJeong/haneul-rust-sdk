...
use haneul_sdk_types::Bn254FieldElement;
use haneul_sdk_types::CircomG1;
use haneul_sdk_types::CircomG2;
...
use haneul_sdk_types::ZkLoginProof;
...
/// Calculate the Haneul address based on address seed and address params.
#[allow(unused)]
fn gen_address_seed(
    salt: &str,
    name: &str,  // i.e. "sub"
