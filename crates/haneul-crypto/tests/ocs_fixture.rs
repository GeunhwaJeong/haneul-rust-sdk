...
//! Haneul checkpoint summary.
//!
//! This test is the BLS half of the OCS-fixture pin in
//! `crates/haneul-sdk-types/tests/ocs_fixture.rs`. Together the two
...
//!    haneul-sdk-types test).
//!
//! The fixtures are shared with the haneul-sdk-types test and live at
//! `crates/haneul-sdk-types/tests/fixtures/ocs/`. They originate from
//! PR #223 of HaneulLabs/haneul-rust-sdk at commit 25a17590.
...
/// Path to a fixture file in the sister `haneul-sdk-types` crate's tests
...
macro_rules! sister_fixture {
    ($rel:literal) => {
        concat!(
            ...
            "/../haneul-sdk-types/tests/fixtures/ocs/",
            $rel,
        )
    };
}
