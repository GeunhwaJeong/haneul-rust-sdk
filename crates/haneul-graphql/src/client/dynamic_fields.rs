...
impl Client {
    ...
    async fn fetch_dynamic_fields_page_with_formats(
        ...
        const QUERY: &str = graphql_query!(
            ...
            query($parent: HaneulAddress!, $cursor: String, $withJson: Boolean!, $withBcs: Boolean!) {
    ...
    async fn fetch_single_dynamic_field<N: Serialize>(
        ...
        const DYNAMIC_FIELD_QUERY: &str = graphql_query!(
            ...
            query($parent: HaneulAddress!, $name: DynamicFieldName!, $withJson: Boolean!, $withBcs: Boolean!) {
                object(address: $parent) {
                            ...
                            "nodes": [
                                {
                                    ...
                                    "value": {
                                        ...
                                        "type": { "repr": "0x2::coin::Coin<0x2::haneul::HANEUL>" },
                                        "json": { "balance": "1000" }
                                    }
                                },
                                {
