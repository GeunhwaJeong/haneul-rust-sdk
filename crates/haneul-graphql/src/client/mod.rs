//! GraphQL client for Haneul blockchain.
...
impl Client {
    /// URL for the Haneul Foundation provided GraphQL service for mainnet.
    pub const MAINNET: &str = "https://graphql.mainnet.haneul.io/graphql";

    /// URL for the Haneul Foundation provided GraphQL service for testnet.
    pub const TESTNET: &str = "https://graphql.testnet.haneul.io/graphql";

    /// URL for the Haneul Foundation provided GraphQL service for devnet.
    pub const DEVNET: &str = "https://graphql.devnet.haneul.io/graphql";
    ...
    /// ```no_run
    /// use haneul_graphql::Client;
    /// use haneul_graphql::header::HeaderMap;
    /// use haneul_graphql::header::HeaderValue;
    ///
    ...
    ///
    /// Mirrors [`haneul_rpc::client::HeadersInterceptor::bearer_auth`] for
    ...
    ///
    /// Mirrors [`haneul_rpc::client::HeadersInterceptor::basic_auth`] for
    /// cross-transport API consistency.
