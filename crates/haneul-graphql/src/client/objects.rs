...
impl Client {
    ...
    pub async fn get_object_at_version(
        ...
        const QUERY: &str = graphql_query!(
            "query($id: HaneulAddress!, $version: UInt53) {
    ...
    pub async fn get_object_at_checkpoint(
        ...
        const QUERY: &str = graphql_query!(
            "query($id: HaneulAddress!, $atCheckpoint: UInt53) {
    ...
    pub async fn get_object_with_root_version(
        ...
        const QUERY: &str = graphql_query!(
            "query($id: HaneulAddress!, $rootVersion: UInt53) {
...
mod tests {
    ...
    /// BCS-encoded HANEUL coin from haneul-sdk-types test fixtures, encoded as base64.
    fn test_object_bcs() -> String {
        use base64ct::Base64;
        use base64ct::Encoding;

        // From haneul-sdk-types/src/object.rs test fixtures (HANEUL_COIN)
        const HANEUL_COIN_BCS: &[u8] = &[
        ...
        Base64::encode_string(HANEUL_COIN_BCS)
    }
