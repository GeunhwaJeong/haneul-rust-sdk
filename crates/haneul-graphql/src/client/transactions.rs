...
/// A balance change from a transaction (re-exported from haneul-rpc).
pub use haneul_rpc::proto::haneul::rpc::v2::BalanceChange;
...
impl Client {
    ...
    ///
    /// let client = Client::new("https://graphql.mainnet.haneul.io/graphql")?;
