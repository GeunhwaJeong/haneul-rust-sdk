...
impl From<haneul_sdk_types::TypeParseError> for Error {
    fn from(err: haneul_sdk_types::TypeParseError) -> Self {
...
impl From<haneul_sdk_types::DigestParseError> for Error {
    fn from(err: haneul_sdk_types::DigestParseError) -> Self {
