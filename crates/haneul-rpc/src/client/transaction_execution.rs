...
use crate::proto::haneul::rpc::v2::ExecuteTransactionRequest;
use crate::proto::haneul::rpc::v2::ExecuteTransactionResponse;
use crate::proto::haneul::rpc::v2::ExecutionError;
use crate::proto::haneul::rpc::v2::GetEpochRequest;
use crate::proto::haneul::rpc::v2::GetTransactionRequest;
use crate::proto::haneul::rpc::v2::GetTransactionResponse;
use crate::proto::haneul::rpc::v2::SubscribeCheckpointsRequest;
...
impl Client {
    ...
    pub async fn execute_transaction_and_wait_for_checkpoint(
        ...
        let executed_txn_digest = match haneul_sdk_types::Transaction::try_from(transaction) {
