...
impl FaucetClient {
    ...
    pub const TESTNET: &str = "https://faucet.testnet.haneul.io";
    /// URL for the devnet faucet.
    pub const DEVNET: &str = "https://faucet.devnet.haneul.io";
...
"Missing X-Turnstile-Token header. For testnet tokens, please use the Web UI: https://faucet.haneul.io"
            ),
