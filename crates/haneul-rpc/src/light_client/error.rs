...
use haneul_sdk_types::framework::ApplyStreamError;
use haneul_sdk_types::framework::EventStreamHead;
use haneul_sdk_types::proof::ProofError;
...
pub enum LightClientError {
    ...
    InvalidSignature(haneul_crypto::SignatureError),
    ...
    ///
    /// [`Object`]: haneul_sdk_types::Object
    ...
    ///
    /// [`apply_stream_updates`]: haneul_sdk_types::framework::apply_stream_updates
...
impl From<haneul_crypto::SignatureError> for LightClientError {
    fn from(value: haneul_crypto::SignatureError) -> Self {
