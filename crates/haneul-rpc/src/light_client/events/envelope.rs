...
use crate::proto::haneul::rpc::v2alpha::EventItem;
...
/// `haneul_sdk_types::framework::EventCommitment`.
///
...
mod tests {
    use super::*;
    use crate::proto::haneul::rpc::v2::Bcs;
    use crate::proto::haneul::rpc::v2::Event as ProtoEvent;
