...
use haneul_sdk_types::framework::EventBatch;
use haneul_sdk_types::framework::EventCommitment;
use haneul_sdk_types::framework::EventStreamHead;
use haneul_sdk_types::framework::apply_stream_updates;
...
/// `haneul::dynamic_field::Field<haneul::accumulator::Key<EventStreamHead>,
...
mod tests {
    ...
    fn extract_event_stream_head_skips_uid_and_key_prefix() {
        use haneul_sdk_types::Object;
        use haneul_sdk_types::ObjectData;
        ...
        let move_struct = haneul_sdk_types::MoveStruct::new(
            StructTag::new(
                Address::TWO,
    ...
    fn extract_event_stream_head_rejects_non_struct() {
        use haneul_sdk_types::MovePackage;
        use haneul_sdk_types::Object;
        use haneul_sdk_types::ObjectData;
        use haneul_sdk_types::Owner;
        use haneul_sdk_types::Version;
