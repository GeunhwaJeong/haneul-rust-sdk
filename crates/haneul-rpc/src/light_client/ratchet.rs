...
async fn fetch_one_epoch(
    ...
    epoch_number: u64,
    config: &RatchetConfig,
) -> Result<crate::proto::haneul::rpc::v2::Epoch, LightClientError> {
...
mod tests {
    ...
    use haneul_sdk_types::EndOfEpochData;
    use haneul_sdk_types::GasCostSummary;
    use haneul_sdk_types::ValidatorCommitteeMember;
