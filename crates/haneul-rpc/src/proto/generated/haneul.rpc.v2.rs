...
/// [BCS](<https://mystenlabs.github.io/haneul-rust-sdk/sui_sdk_types/index.html#bcs>)
...
pub struct Epoch {
    ...
    /// current epoch.
    #[prost(message, optional, tag = "3")]
    pub system_state: ::core::option::Option<SystemState>,
    #[prost(uint64, optional, tag = "4")]
...
pub struct Input {
    ...
    pub literal: ::core::option::Option<::prost_types::Value>,
}
...
///
/// See
/// [struct.PasskeyAuthenticator](<https://mystenlabs.github.io/haneul-rust-sdk/sui_sdk_types/struct.PasskeyAuthenticator.html#bcs>)
...
/// [enum.SignatureScheme](<https://mystenlabs.github.io/haneul-rust-sdk/sui_sdk_types/enum.SignatureScheme.html>)
