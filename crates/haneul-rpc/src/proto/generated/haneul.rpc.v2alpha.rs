        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LedgerService/ListCheckpoints",
            );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LedgerService/ListTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.LedgerService/ListEvents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
...
pub mod ledger_service_server {
    ...
    pub const SERVICE_NAME: &str = "haneul.rpc.v2alpha.LedgerService";
...
pub mod proof_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/haneul.rpc.v2alpha.ProofService/GetCheckpointObjectProof",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "haneul.rpc.v2alpha.ProofService",
...
pub mod proof_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "haneul.rpc.v2alpha.ProofService";
