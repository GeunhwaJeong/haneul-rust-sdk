...
impl From<haneul_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn from(summary: haneul_sdk_types::CheckpointSummary) -> Self {
        Self::merge_from(summary, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<haneul_sdk_types::CheckpointSummary> for CheckpointSummary {
    fn merge(&mut self, source: haneul_sdk_types::CheckpointSummary, mask: &FieldMaskTree) {
        ...
        let haneul_sdk_types::CheckpointSummary {
            epoch,
            sequence_number,
...
impl TryFrom<&CheckpointSummary> for haneul_sdk_types::CheckpointSummary {
...
impl From<haneul_sdk_types::GasCostSummary> for GasCostSummary {
    fn from(
...
impl TryFrom<&GasCostSummary> for haneul_sdk_types::GasCostSummary {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CheckpointCommitment> for CheckpointCommitment {
    fn from(value: haneul_sdk_types::CheckpointCommitment) -> Self {
        ...
        let kind = match value {
            ...
            haneul_sdk_types::CheckpointCommitment::CheckpointArtifacts { digest } => {
                message.digest = Some(digest.to_string());
...
impl TryFrom<&CheckpointCommitment> for haneul_sdk_types::CheckpointCommitment {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::EndOfEpochData> for EndOfEpochData {
    fn from(
...
impl TryFrom<&EndOfEpochData> for haneul_sdk_types::EndOfEpochData {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::CheckpointTransactionInfo> for CheckpointedTransactionInfo {
...
impl TryFrom<&CheckpointedTransactionInfo> for haneul_sdk_types::CheckpointTransactionInfo {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &CheckpointedTransactionInfo) -> Result<Self, Self::Error> {
        ...
        let signatures: Vec<haneul_sdk_types::UserSignature> = value
            .signatures
            .iter()
            .map(TryInto::try_into)
            .collect::<Result<_, _>>()?;
...
impl From<haneul_sdk_types::CheckpointContents> for CheckpointContents {
    fn from(value: haneul_sdk_types::CheckpointContents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<haneul_sdk_types::CheckpointContents> for CheckpointContents {
    fn merge(&mut self, source: haneul_sdk_types::CheckpointContents, mask: &FieldMaskTree) {
        if mask.contains(Self::BCS_FIELD.name) {
            let mut bcs = Bcs::serialize(&source).unwrap();
...
impl TryFrom<&CheckpointContents> for haneul_sdk_types::CheckpointContents {
    type Error = TryFromProtoError;
...
impl Merge<&haneul_sdk_types::CheckpointSummary> for Checkpoint {
    fn merge(&mut self, source: &haneul_sdk_types::CheckpointSummary, mask: &FieldMaskTree) {
        if mask.contains(Self::SEQUENCE_NUMBER_FIELD.name) {
...
impl Merge<haneul_sdk_types::ValidatorAggregatedSignature> for Checkpoint {
    fn merge(&mut self, source: haneul_sdk_types::ValidatorAggregatedSignature, mask: &FieldMaskTree) {
...
impl Merge<haneul_sdk_types::CheckpointContents> for Checkpoint {
    fn merge(&mut self, source: haneul_sdk_types::CheckpointContents, mask: &FieldMaskTree) {
