...
impl From<haneul_sdk_types::Event> for Event {
    fn from(value: haneul_sdk_types::Event) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<haneul_sdk_types::Event> for Event {
    fn merge(&mut self, source: haneul_sdk_types::Event, mask: &FieldMaskTree) {
...
impl TryFrom<&Event> for haneul_sdk_types::Event {
...
impl From<haneul_sdk_types::TransactionEvents> for TransactionEvents {
    fn from(value: haneul_sdk_types::TransactionEvents) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<haneul_sdk_types::TransactionEvents> for TransactionEvents {
    fn merge(&mut self, source: haneul_sdk_types::TransactionEvents, mask: &FieldMaskTree) {
...
impl TryFrom<&TransactionEvents> for haneul_sdk_types::TransactionEvents {
    type Error = TryFromProtoError;
