...
impl From<haneul_sdk_types::ExecutionStatus> for ExecutionStatus {
...
impl TryFrom<&ExecutionStatus> for haneul_sdk_types::ExecutionStatus {
    ...
    fn try_from(value: &ExecutionStatus) -> Result<Self, Self::Error> {
        ...
        match (success, &value.error) {
            ...
            (false, Some(error)) => Self::Failure {
                error: haneul_sdk_types::ExecutionError::try_from(error)
...
impl TryFrom<&ExecutionError> for haneul_sdk_types::ExecutionError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CommandArgumentError> for CommandArgumentError {
    fn from(value: haneul_sdk_types::CommandArgumentError) -> Self {
        use command_argument_error::CommandArgumentErrorKind;
        use haneul_sdk_types::CommandArgumentError as E;
...
impl TryFrom<&CommandArgumentError> for haneul_sdk_types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TypeArgumentError> for type_argument_error::TypeArgumentErrorKind {
...
impl TryFrom<type_argument_error::TypeArgumentErrorKind> for haneul_sdk_types::TypeArgumentError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::PackageUpgradeError> for PackageUpgradeError {
    fn from(value: haneul_sdk_types::PackageUpgradeError) -> Self {
        use package_upgrade_error::PackageUpgradeErrorKind;
        use haneul_sdk_types::PackageUpgradeError as E;
...
impl TryFrom<&PackageUpgradeError> for haneul_sdk_types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MoveLocation> for MoveLocation {
...
impl TryFrom<&MoveLocation> for haneul_sdk_types::MoveLocation {
    type Error = TryFromProtoError;
