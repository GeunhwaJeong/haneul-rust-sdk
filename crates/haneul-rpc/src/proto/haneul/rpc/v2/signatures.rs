...
impl From<haneul_sdk_types::ValidatorAggregatedSignature> for ValidatorAggregatedSignature {
...
impl TryFrom<&ValidatorAggregatedSignature> for haneul_sdk_types::ValidatorAggregatedSignature {
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        let bitmap = haneul_sdk_types::Bitmap::deserialize_from(value.bitmap()).map_err(|e| {
...
impl From<haneul_sdk_types::ValidatorCommitteeMember> for ValidatorCommitteeMember {
...
impl TryFrom<&ValidatorCommitteeMember> for haneul_sdk_types::ValidatorCommitteeMember {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ValidatorCommittee> for ValidatorCommittee {
...
impl TryFrom<&ValidatorCommittee> for haneul_sdk_types::ValidatorCommittee {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CircomG1> for CircomG1 {
...
impl TryFrom<&CircomG1> for haneul_sdk_types::CircomG1 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CircomG2> for CircomG2 {
...
impl TryFrom<&CircomG2> for haneul_sdk_types::CircomG2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ZkLoginClaim> for ZkLoginClaim {
    fn from(
...
impl TryFrom<&ZkLoginClaim> for haneul_sdk_types::ZkLoginClaim {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ZkLoginProof> for ZkLoginProof {
...
impl TryFrom<&ZkLoginProof> for haneul_sdk_types::ZkLoginProof {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ZkLoginInputs> for ZkLoginInputs {
    fn from(value: haneul_sdk_types::ZkLoginInputs) -> Self {
        Self {
...
impl TryFrom<&ZkLoginInputs> for haneul_sdk_types::ZkLoginInputs {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ZkLoginAuthenticator> for ZkLoginAuthenticator {
...
impl TryFrom<&ZkLoginAuthenticator> for haneul_sdk_types::ZkLoginAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
...
impl TryFrom<&ZkLoginPublicIdentifier> for haneul_sdk_types::ZkLoginPublicIdentifier {
    type Error = TryFromProtoError;
...
impl TryFrom<&SignatureScheme> for haneul_sdk_types::SignatureScheme {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::SimpleSignature> for SimpleSignature {
...
impl TryFrom<&SimpleSignature> for haneul_sdk_types::SimpleSignature {
    type Error = TryFromProtoError;

    fn try_from(value: &SimpleSignature) -> Result<Self, Self::Error> {
        use SignatureScheme;
        use haneul_sdk_types::Ed25519PublicKey;
        use haneul_sdk_types::Ed25519Signature;
        use haneul_sdk_types::Secp256k1PublicKey;
        use haneul_sdk_types::Secp256k1Signature;
        use haneul_sdk_types::Secp256r1PublicKey;
        use haneul_sdk_types::Secp256r1Signature;
...
impl From<haneul_sdk_types::PasskeyAuthenticator> for PasskeyAuthenticator {
...
impl TryFrom<&PasskeyAuthenticator> for haneul_sdk_types::PasskeyAuthenticator {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::MultisigMemberPublicKey> for MultisigMemberPublicKey {
...
impl TryFrom<&MultisigMemberPublicKey> for haneul_sdk_types::MultisigMemberPublicKey {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigMemberPublicKey) -> Result<Self, Self::Error> {
        ...
        match value.scheme() {
            ...
            SignatureScheme::Passkey => Self::Passkey(haneul_sdk_types::PasskeyPublicKey::new(
...
impl From<&haneul_sdk_types::MultisigMember> for MultisigMember {
...
impl TryFrom<&MultisigMember> for haneul_sdk_types::MultisigMember {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::MultisigCommittee> for MultisigCommittee {
...
impl TryFrom<&MultisigCommittee> for haneul_sdk_types::MultisigCommittee {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::MultisigMemberSignature> for MultisigMemberSignature {
...
impl TryFrom<&MultisigMemberSignature> for haneul_sdk_types::MultisigMemberSignature {
    type Error = TryFromProtoError;
...
impl From<&haneul_sdk_types::MultisigAggregatedSignature> for MultisigAggregatedSignature {
...
impl TryFrom<&MultisigAggregatedSignature> for haneul_sdk_types::MultisigAggregatedSignature {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &MultisigAggregatedSignature) -> Result<Self, Self::Error> {
        ...
        if let Some(legacy_bitmap) = value.legacy_bitmap_opt() {
            let legacy_bitmap =
                haneul_sdk_types::Bitmap::deserialize_from(legacy_bitmap).map_err(|e| {
...
impl From<haneul_sdk_types::UserSignature> for UserSignature {
    fn from(value: haneul_sdk_types::UserSignature) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<haneul_sdk_types::UserSignature> for UserSignature {
...
impl TryFrom<&UserSignature> for haneul_sdk_types::UserSignature {
    type Error = TryFromProtoError;
