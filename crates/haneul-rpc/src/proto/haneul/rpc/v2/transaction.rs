...
impl From<haneul_sdk_types::Transaction> for Transaction {
    fn from(value: haneul_sdk_types::Transaction) -> Self {
        Self::merge_from(value, &FieldMaskTree::new_wildcard())
    }
}

impl Merge<haneul_sdk_types::Transaction> for Transaction {
    fn merge(&mut self, source: haneul_sdk_types::Transaction, mask: &FieldMaskTree) {
...
impl TryFrom<&Transaction> for haneul_sdk_types::Transaction {
...
impl From<haneul_sdk_types::GasPayment> for GasPayment {
...
impl TryFrom<&GasPayment> for haneul_sdk_types::GasPayment {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TransactionExpiration> for TransactionExpiration {
...
impl TryFrom<&TransactionExpiration> for haneul_sdk_types::TransactionExpiration {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TransactionKind> for TransactionKind {
    fn from(value: haneul_sdk_types::TransactionKind) -> Self {
        use haneul_sdk_types::TransactionKind as K;
...
impl TryFrom<&TransactionKind> for haneul_sdk_types::TransactionKind {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologue> for ConsensusCommitPrologue {
...
impl TryFrom<&ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologue {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologueV2> for ConsensusCommitPrologue {
...
impl TryFrom<&ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologueV2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologueV3> for ConsensusCommitPrologue {
...
impl TryFrom<&ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologueV3 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ConsensusCommitPrologueV4> for ConsensusCommitPrologue {
    fn from(
...
impl TryFrom<&ConsensusCommitPrologue> for haneul_sdk_types::ConsensusCommitPrologueV4 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CanceledTransaction> for CanceledTransaction {
...
impl TryFrom<&CanceledTransaction> for haneul_sdk_types::CanceledTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::CanceledTransactionV2> for CanceledTransaction {
    fn from(value: haneul_sdk_types::CanceledTransactionV2) -> Self {
        Self {
            digest: Some(value.digest.to_string()),
            version_assignments: value
                .version_assignments
...
impl TryFrom<&CanceledTransaction> for haneul_sdk_types::CanceledTransactionV2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::VersionAssignment> for VersionAssignment {
...
impl TryFrom<&VersionAssignment> for haneul_sdk_types::VersionAssignment {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::VersionAssignmentV2> for VersionAssignment {
    fn from(value: haneul_sdk_types::VersionAssignmentV2) -> Self {
        Self {
            object_id: Some(value.object_id.to_string()),
...
impl TryFrom<&VersionAssignment> for haneul_sdk_types::VersionAssignmentV2 {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::GenesisTransaction> for GenesisTransaction {
...
impl TryFrom<&GenesisTransaction> for haneul_sdk_types::GenesisTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::RandomnessStateUpdate> for RandomnessStateUpdate {
...
impl TryFrom<&RandomnessStateUpdate> for haneul_sdk_types::RandomnessStateUpdate {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::AuthenticatorStateUpdate> for AuthenticatorStateUpdate {
...
impl TryFrom<&AuthenticatorStateUpdate> for haneul_sdk_types::AuthenticatorStateUpdate {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Jwk> for Jwk {
...
impl TryFrom<&Jwk> for haneul_sdk_types::Jwk {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::JwkId> for JwkId {
...
impl From<&haneul_sdk_types::JwkId> for JwkId {
    fn from(value: &haneul_sdk_types::JwkId) -> Self {
        Self {
...
impl TryFrom<&JwkId> for haneul_sdk_types::JwkId {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ActiveJwk> for ActiveJwk {
...
impl TryFrom<&ActiveJwk> for haneul_sdk_types::ActiveJwk {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ChangeEpoch> for ChangeEpoch {
...
impl TryFrom<&ChangeEpoch> for haneul_sdk_types::ChangeEpoch {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::SystemPackage> for SystemPackage {
...
impl TryFrom<&SystemPackage> for haneul_sdk_types::SystemPackage {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::EndOfEpochTransactionKind> for EndOfEpochTransactionKind {
    fn from(value: haneul_sdk_types::EndOfEpochTransactionKind) -> Self {
        use end_of_epoch_transaction_kind::Kind;
        use haneul_sdk_types::EndOfEpochTransactionKind as K;
...
impl TryFrom<&EndOfEpochTransactionKind> for haneul_sdk_types::EndOfEpochTransactionKind {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::AuthenticatorStateExpire> for AuthenticatorStateExpire {
...
impl TryFrom<&AuthenticatorStateExpire> for haneul_sdk_types::AuthenticatorStateExpire {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ExecutionTimeObservations> for ExecutionTimeObservations {
    fn from(value: haneul_sdk_types::ExecutionTimeObservations) -> Self {
        match value {
            haneul_sdk_types::ExecutionTimeObservations::V1(vec) => Self {
                version: Some(1),
...
impl TryFrom<&ExecutionTimeObservations> for haneul_sdk_types::ExecutionTimeObservations {
    type Error = TryFromProtoError;
...
impl
    From<(
        haneul_sdk_types::ExecutionTimeObservationKey,
        Vec<haneul_sdk_types::ValidatorExecutionTimeObservation>,
    )> for ExecutionTimeObservation
{
    fn from(
        ...
        use haneul_sdk_types::ExecutionTimeObservationKey;
    ...
    )
{
    ...
    fn try_from(value: &ExecutionTimeObservation) -> Result<Self, Self::Error> {
        ...
        let observations = value
            ...
            .iter()
            .map(haneul_sdk_types::ValidatorExecutionTimeObservation::try_from)
            .collect::<Result<_, _>>()?;
...
impl From<haneul_sdk_types::ValidatorExecutionTimeObservation> for ValidatorExecutionTimeObservation {
    fn from(value: haneul_sdk_types::ValidatorExecutionTimeObservation) -> Self {
        Self {
...
impl TryFrom<&ValidatorExecutionTimeObservation>
    for haneul_sdk_types::ValidatorExecutionTimeObservation
{
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ProgrammableTransaction> for ProgrammableTransaction {
...
impl TryFrom<&ProgrammableTransaction> for haneul_sdk_types::ProgrammableTransaction {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Input> for Input {
...
impl TryFrom<&Input> for haneul_sdk_types::Input {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &Input) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            InputKind::ImmutableOrOwned => {
                ...
                let reference = haneul_sdk_types::ObjectReference::new(object_id, version, digest);
            ...
            InputKind::Shared => {
                ...
                let shared_input = match value.mutability() {
                    input::Mutability::Unknown => {
                        ...
                        haneul_sdk_types::SharedInput::new(object_id, initial_shared_version, mutable)
                    }
                    input::Mutability::Immutable => haneul_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        haneul_sdk_types::Mutability::Immutable,
                    ),
                    input::Mutability::Mutable => haneul_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        haneul_sdk_types::Mutability::Mutable,
                    ),
                    input::Mutability::NonExclusiveWrite => haneul_sdk_types::SharedInput::new(
                        object_id,
                        initial_shared_version,
                        haneul_sdk_types::Mutability::NonExclusiveWrite,
                    ),
                };
...
impl From<haneul_sdk_types::Mutability> for input::Mutability {
    fn from(value: haneul_sdk_types::Mutability) -> Self {
        match value {
            haneul_sdk_types::Mutability::Immutable => Self::Immutable,
            haneul_sdk_types::Mutability::Mutable => Self::Mutable,
            haneul_sdk_types::Mutability::NonExclusiveWrite => Self::NonExclusiveWrite,
        }
    }
}
...
impl From<haneul_sdk_types::FundsWithdrawal> for FundsWithdrawal {
    fn from(value: haneul_sdk_types::FundsWithdrawal) -> Self {
        let mut message = Self::default();
...
impl TryFrom<&FundsWithdrawal> for haneul_sdk_types::FundsWithdrawal {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::WithdrawFrom> for funds_withdrawal::Source {
    fn from(value: haneul_sdk_types::WithdrawFrom) -> Self {
        match value {
...
impl From<haneul_sdk_types::Argument> for Argument {
...
impl TryFrom<&Argument> for haneul_sdk_types::Argument {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Command> for Command {
...
impl TryFrom<&Command> for haneul_sdk_types::Command {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MoveCall> for MoveCall {
...
impl TryFrom<&MoveCall> for haneul_sdk_types::MoveCall {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::TransferObjects> for TransferObjects {
...
impl TryFrom<&TransferObjects> for haneul_sdk_types::TransferObjects {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::SplitCoins> for SplitCoins {
...
impl TryFrom<&SplitCoins> for haneul_sdk_types::SplitCoins {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MergeCoins> for MergeCoins {
...
impl TryFrom<&MergeCoins> for haneul_sdk_types::MergeCoins {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Publish> for Publish {
...
impl TryFrom<&Publish> for haneul_sdk_types::Publish {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::MakeMoveVector> for MakeMoveVector {
...
impl TryFrom<&MakeMoveVector> for haneul_sdk_types::MakeMoveVector {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Upgrade> for Upgrade {
...
impl TryFrom<&Upgrade> for haneul_sdk_types::Upgrade {
    type Error = TryFromProtoError;
