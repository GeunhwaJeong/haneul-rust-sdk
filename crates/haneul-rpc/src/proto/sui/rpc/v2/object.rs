...
impl Merge<haneul_sdk_types::Object> for Object {
    fn merge(&mut self, source: haneul_sdk_types::Object, mask: &FieldMaskTree) {
        if mask.contains(Self::BCS_FIELD.name) {
...
impl Merge<&haneul_sdk_types::MoveStruct> for Object {
    fn merge(&mut self, source: &haneul_sdk_types::MoveStruct, mask: &FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
impl Merge<&haneul_sdk_types::MovePackage> for Object {
    fn merge(&mut self, source: &haneul_sdk_types::MovePackage, mask: &FieldMaskTree) {
        if mask.contains(Self::OBJECT_TYPE_FIELD.name) {
...
fn try_extract_struct(value: &Object) -> Result<haneul_sdk_types::MoveStruct, TryFromProtoError> {
    ...
    haneul_sdk_types::MoveStruct::new(object_type, has_public_transfer, version, contents).ok_or_else(
...
impl From<haneul_sdk_types::TypeOrigin> for TypeOrigin {
...
impl TryFrom<&TypeOrigin> for haneul_sdk_types::TypeOrigin {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::ObjectReference> for ObjectReference {
...
impl TryFrom<&ObjectReference> for haneul_sdk_types::ObjectReference {
    type Error = TryFromProtoError;
...
impl From<haneul_sdk_types::Owner> for Owner {
...
impl TryFrom<&Owner> for haneul_sdk_types::Owner {
    type Error = TryFromProtoError;
...
impl ObjectSet {
    ...
    pub fn binary_search<'a>(
        &'a self,
        object_id: &haneul_sdk_types::Address,
        version: u64,
    ) -> Option<&'a Object> {
