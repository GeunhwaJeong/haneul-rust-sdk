...
/// Haneul blockchain. The number of required signautres to authorize the execution of a transaction
...
/// verifier in `haneul-crypto` before any signature is verified.
///
