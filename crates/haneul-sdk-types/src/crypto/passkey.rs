...
/// the required json-schema for the `client-data-json` rule. In addition, Haneul currently requires
...
mod serialization {
    ...
    pub(super) enum ClientDataType {
        ...
        ///
        /// Passkey's in Haneul only support the value `"webauthn.get"`, other values will be rejected.
