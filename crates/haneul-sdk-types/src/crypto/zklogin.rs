...
/// ## Note
///
/// Due to a historical bug that was introduced in the Haneul Typescript SDK when the zklogin
...
/// these addresses, the Haneul network decided to change the protocol to allow for a zklogin
