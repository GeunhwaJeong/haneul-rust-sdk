//! Rust definitions of move/haneul framework types.
...
///
/// Mirrors `haneul::accumulator_settlement::EventCommitment` on the Move side.
///
/// [`Event`]: crate::Event
///
/// # BCS
...
/// head reflects.
///
/// Mirrors `haneul::accumulator_settlement::EventStreamHead`.
///
...
/// `haneul::accumulator::Key<haneul::accumulator_settlement::EventStreamHead>`,
...
/// use haneul_sdk_types::framework::derive_event_stream_head_object_id;
///
/// // Pinned interop vector cross-verified against
/// // `haneul_types::accumulator_root::derive_event_stream_head_object_id`.
...
pub fn derive_event_stream_head_object_id(stream_id: Address) -> Address {
    ...
    // Value type: `haneul::accumulator_settlement::EventStreamHead`. Captured
    ...
    // Key type: `haneul::accumulator::Key<EventStreamHead>`.
...
/// `haneul-framework/sources/accumulator_settlement.move`. Any divergence
...
mod test {
    ...
    // `haneul::accumulator_settlement::EventCommitment` upstream byte-for-byte,
    ...
    // running `haneul_types::accumulator_root::build_event_merkle_root`
    ...
    // `haneul-framework/sources/accumulator_settlement.move`. Inserting
    ...
    // `haneul_light_client::authenticated_events::mmr::apply_stream_updates`
