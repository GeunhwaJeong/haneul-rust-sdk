...
impl crate::Ed25519PublicKey {
    ...
    /// use haneul_sdk_types::hash::Hasher;
    ///
...
/// A 1-byte domain separator for deriving `ObjectId`s in Haneul. It is starting from `0xf0` to ensure
