//! Known-answer tests for OCS proof verification against a real Haneul
//! checkpoint.
//!
...
//!
//! The fixture was lifted from PR #223 of HaneulLabs/haneul-rust-sdk
//! (`crates/haneul-authenticated-events-client/tests/test_files/ocs/1137.chk`
//! at commit 25a17590), where it was originally captured for the
//! relocated authenticated-events client.
//!
//! [`TransactionEffects::object_changes`]: haneul_sdk_types::TransactionEffects::object_changes
...
use haneul_sdk_types::CheckpointCommitment;
use haneul_sdk_types::CheckpointData;
use haneul_sdk_types::CheckpointSummary;
use haneul_sdk_types::Digest;
use haneul_sdk_types::ObjectChange;
...
fn recompute_artifacts_digest(tree_root: Digest) -> Digest {
    ...
    haneul_sdk_types::hash::Hasher::digest(bytes)
}
