...
//! Transaction building API for the [Haneul] blockchain.
//!
...
//! resolves them into a finalized [`Transaction`](haneul_sdk_types::Transaction).
//!
...
//! # Example
//!
//! Build a simple HANEUL transfer transaction offline using [`TransactionBuilder::try_build`]:
//!
//! ```
...
//!
//! // Split 1 HANEUL from the gas coin
