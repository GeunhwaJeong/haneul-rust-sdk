...
use error::Error;
use haneul_types::Address;
use haneul_types::Argument;
use haneul_types::Command;
use haneul_types::GasPayment;
use haneul_types::Identifier;
use haneul_types::Input;
use haneul_types::MakeMoveVector;
use haneul_types::MergeCoins;
use haneul_types::MoveCall;
use haneul_types::ObjectReference;
use haneul_types::Publish;
use haneul_types::SharedInput;
use haneul_types::SplitCoins;
use haneul_types::Transaction;
use haneul_types::TransactionExpiration;
use haneul_types::TransferObjects;
use haneul_types::TypeTag;
use haneul_types::Upgrade;
...
impl TransactionBuilder {
    ...
    pub fn finish(self) -> Result<Transaction, Error> {
        ...
        Ok(Transaction {
            kind: haneul_types::TransactionKind::ProgrammableTransaction(
                haneul_types::ProgrammableTransaction {
                    inputs: self
                        .inputs
                        .into_iter()
...
//     use haneul_types::framework::Coin;
//     use haneul_types::Address;
//     use haneul_types::Digest;
//     use haneul_types::ExecutionStatus;
//     use haneul_types::IdOperation;
//     use haneul_types::ObjectType;
//     use haneul_types::TransactionEffects;
//     use haneul_types::TypeTag;
...
//         client: &Client,
//         digest: Digest,
//         effects: Result<Option<TransactionEffects>, haneul_graphql_client::error::Error>,
//     ) {
...
//                             match change {
//                                 haneul_types::ObjectOut::PackageWrite { .. } => {
//                                     package_id = Some(obj.object_id);
//                                 }
//                                 haneul_types::ObjectOut::ObjectWrite { .. } => {
...
//                         haneul_types::Owner::Object(_) => {
//                             panic!("Upgrade capability controlled by object")
//                         }
//                         haneul_types::Owner::Immutable => panic!("Upgrade capability is stored immutably and cannot be used for upgrades"),
//                         haneul_types::Owner::ConsensusAddress { .. } => {
//                             upgrade_cap = Some(tx.input(&obj))
//                         }
